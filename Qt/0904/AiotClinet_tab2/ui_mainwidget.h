...
public:
    ...
    void retranslateUi(QWidget *MainWidget)
    {
        ...
        pTabWidget->setTabText(pTabWidget->indexOf(pTab4), QCoreApplication::translate("MainWidget", "Tab4", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab5), QCoreApplication::translate("MainWidget", "Tab5", nullptr));
    } // retranslateUi
