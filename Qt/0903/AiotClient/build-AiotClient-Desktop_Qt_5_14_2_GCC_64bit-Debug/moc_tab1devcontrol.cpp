...
#include <memory>
#include "../AiotClient_tab2/tab1devcontrol.h"
...
QT_MOC_LITERAL(1, 15, 15), // "writeLedDataSig"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 18), // "on_pPBQuit_clicked"
QT_MOC_LITERAL(4, 51, 20), // "slotTimerStartButton"
QT_MOC_LITERAL(5, 72, 16), // "slotDialSetValue"
QT_MOC_LITERAL(6, 89, 36), // "on_pCBtimerValue_currentIndex..."
QT_MOC_LITERAL(7, 126, 4), // "arg1"
QT_MOC_LITERAL(8, 131, 21), // "slotKeyCheckBoxUpdate"
QT_MOC_LITERAL(9, 153, 26) // "slotKeyCheckBoxUpdateMouse"

    },
    "Tab1DevControl\0writeLedDataSig\0\0"
    "on_pPBQuit_clicked\0slotTimerStartButton\0"
    "slotDialSetValue\0on_pCBtimerValue_currentIndexChanged\0"
    "arg1\0slotKeyCheckBoxUpdate\0"
    "slotKeyCheckBoxUpdateMouse"
};
...
void Tab1DevControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->writeLedDataSig((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_pPBQuit_clicked(); break;
        case 2: _t->slotTimerStartButton((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->slotDialSetValue(); break;
        case 4: _t->on_pCBtimerValue_currentIndexChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->slotKeyCheckBoxUpdate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->slotKeyCheckBoxUpdateMouse((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tab1DevControl::writeLedDataSig)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Tab1DevControl::writeLedDataSig(int _t1)
{
